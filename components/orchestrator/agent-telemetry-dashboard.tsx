...
export default function AgentTelemetryDashboard({ 
  ...
  return (
    <div className="min-h-full flex-1 bg-gradient-to-br from-background via-muted/30 to-background text-foreground">
      <div className="max-w-7xl mx-auto space-y-6 p-4 md:p-6">{/* Responsive padding */}
        
        {/* Header */}
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
            🎯 REROUTE Command Center
          </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-background/50 border-blue-500/30 text-foreground placeholder:text-muted-foreground"
                  rows={3}
                />
              </div>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select value={nodeId} onValueChange={setNodeId}>
                    <SelectTrigger className="bg-background/50 border-blue-500/30 text-foreground">
            ...
            <div className="flex gap-3">
              ...
              {(response || sessionHistory.length > 0) && (
                <Button
                  ...
                  variant="outline"
                  className="bg-background/50 border-border text-muted-foreground hover:bg-accent flex items-center gap-2"
                >
            ...
            <CardContent>
              <div className="space-y-3 max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800 pr-2">
                {sessionHistory.map((historyItem, index) => (
                  <div key={index} className="p-3 bg-muted/50 rounded-lg border border-amber-500/20">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-foreground text-sm line-clamp-2 max-h-12 overflow-hidden">
        ...
        {(isRunning || response || error) && (
          <Card className="border-cyan-500/30 bg-card/80 backdrop-blur-sm">
            <CardHeader>
                    ...
                    <div key={index} className="p-4 bg-muted/50 rounded-lg border border-border">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <div className="text-foreground text-sm leading-relaxed max-h-32 overflow-y-auto">
                            {step.reasoning}
                          </div>
                          ...
                          <div className="mt-3 flex gap-2">
                            <Button
                              ...
                              className="bg-background/50 border-border text-muted-foreground hover:bg-accent flex items-center gap-1"
                            >
        ...
        {response && (
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">{/* Changed from lg to xl for better breakpoint */}
            ...
            {/* Mission Summary */}
            <Card className="xl:col-span-2 border-green-500/30 bg-card/80 backdrop-blur-sm">{/* Updated column span */}
              <CardHeader>
              ...
              <CardContent>
                <div className="prose prose-slate dark:prose-invert max-w-none">
                  <div className="bg-muted/50 p-6 rounded-lg border border-border max-h-[70vh] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800">
                    <div className="text-foreground leading-relaxed [&>h1]:text-2xl [&>h1]:text-blue-600 dark:[&>h1]:text-blue-300 [&>h1]:font-bold [&>h1]:mb-4
                                ...
                                [&>p]:mb-4 [&>p]:text-foreground [&>p]:leading-7
                                [&>ul]:mb-4 [&>ul]:pl-6 [&>ul]:text-foreground
                                [&>ol]:mb-4 [&>ol]:pl-6 [&>ol]:text-foreground
                                ...
                                [&>code]:bg-muted [&>code]:px-2 [&>code]:py-1 [&>code]:rounded [&>code]:text-cyan-700 dark:[&>code]:text-cyan-300
                                [&>pre]:bg-muted [&>pre]:p-4 [&>pre]:rounded-lg [&>pre]:border [&>pre]:border-border
                      ...
                      <ReactMarkdown 
                        components={{
                          ...
                          ul: ({ children }) => <ul className="mb-4 pl-6 text-foreground list-disc">{children}</ul>,
                          ol: ({ children }) => <ol className="mb-4 pl-6 text-foreground list-decimal">{children}</ol>,
                          ...
                          code: ({ children }) => <code className="bg-muted px-2 py-1 rounded text-cyan-700 dark:text-cyan-300">{children}</code>,
                  ...
                  <div className="mt-6">
                    ...
                    <ul className="space-y-3">
                      {response.finalRecommendations.map((rec, index) => (
                        <li key={index} className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg border border-green-500/20">
            ...
            {/* Mission Metrics */}
            <Card className="border-purple-500/30 bg-card/80 backdrop-blur-sm">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <span className="text-muted-foreground text-sm font-medium">Agents Deployed</span>
                ...
                <div className="pt-4 border-t border-border">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-muted-foreground text-sm font-medium">Mission Status</span>
                    <span className="text-green-600 dark:text-green-400 text-sm font-semibold">COMPLETE ✓</span>
                  </div>
                  <Progress 
                    value={100} 
                    className="bg-muted h-2 [&>div]:bg-gradient-to-r [&>div]:from-green-500 [&>div]:to-cyan-500"
                  />
                </div>
              </CardContent>
            </Card>
