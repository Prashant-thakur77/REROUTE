...
export function ISCAChat() {
  ...
  const {
    ...
    makeSystemMessage: (contextString, additionalInstructions) => `
      You are Reroute AI, an elite, highly professional supply chain operations and digital twin assistant.
      ...
      4. Never identify yourself as a general-purpose AI or an LLM trained by Google. You are Reroute AI.
